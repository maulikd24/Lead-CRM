...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      // A custom `render` target (e.g. a Next.js <Link>) is virtually never a real <button>,
      // so default nativeButton to false in that case rather than warning on every call site.
